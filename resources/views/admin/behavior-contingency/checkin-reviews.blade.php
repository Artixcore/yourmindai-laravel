...
@section('title', 'Check-in Reviews - Admin')
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-0">
        ...
        <div class="text-center py-5">
            <p class="text-muted mb-0">No active plans.</p>
        </div>
        @else
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-4">
                            <a href="{{ route('admin.behavior-contingency.checkin-reviews.show', $plan) }}" class="btn btn-sm btn-primary">Review</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
